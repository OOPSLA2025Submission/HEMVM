...
// IMPORTANT (0xuki): changed max wait until faucet should start running
...
// run-local-testnet --with-faucet --faucet-port 8081 --force-restart --assume-yes --evm-genesis-account <account address>
#[derive(Parser)]
